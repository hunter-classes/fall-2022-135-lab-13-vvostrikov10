...
* Notes: divisible can also print the paintings that will need to go to alice to divide the cost evenly. The print statement is commented out for smooth testing experience.
